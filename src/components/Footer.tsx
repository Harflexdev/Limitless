    ...
    <div className='flex flex-col sm:flex-row items-center justify-evenly p-4'>
      <div className='w-full sm:w-1/4 h-auto mb-4 sm:mb-0'>
        <header className="flex items-center">
          <svg className="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
          ...
          <span className="text-xl font-bold">Limitless <span className='text-gray-500'>Go Beyond</span></span>
        </header>
      </div>
      <div className='w-full sm:w-1/2 h-auto'>
        <div className="flex flex-wrap gap-5 font-bold text-sm sm:text-base">
          <Link href="/" className='text-gray-400'>About</Link>
          <Link href="/" className='text-gray-400'>Career</Link>
          <Link href="/" className='text-gray-400'>Help</Link>
          <Link href="/" className='text-gray-400'>Feedback</Link>
          <Link href="/" className='text-gray-400'>@Slack</Link>
          <Link href="/" className='text-gray-400'>Sign in</Link>
        </div>
      </div>
    </div>
  );
